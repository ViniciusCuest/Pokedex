...
export default async function Home() {
  ...
  return (
    <main className='overflow-x-hidden'>
      <header className='flex z-50 border-b-[8px] shadow-xl h-20 w-full border-black_900 bg-gradient-to-r from-max_red to-min_red sm:border-b-[16px] sm:h-36'></header>
      <h1 className='text-3xl font-bold font-sans text-black_900 mb-4 sm:mb-8 sm:text-6xl sm:sticky sm:mt-[-6rem]'>Favoritos</h1>
