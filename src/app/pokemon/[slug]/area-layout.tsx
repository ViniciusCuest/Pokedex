    ...
    <>
      ...
      >
        ...
        <motion.section
          ...
          className='relative flex flex-col justify-center items-center w-full grid-in-stats sm:mt-48 space-y-8 sm:space-y-8'
        >
          <BluredWrapper styles='w-full pt-2 h-20 sm:pt-0 sm:h-auto xl:w-[28rem]'>
                  ...
                  <div className='flex flex-row items-center gap-1'>
                    {
                      data.pokemon_v2_pokemon_by_pk.pokemon_v2_pokemontypes.map((item: any) => {
                        return (
                          <div className={`p-2 rounded-full bg-gradient-to-t ${badgeColor[item.pokemon_v2_type.name]}`}>
                            <span className='flex relative w-7 h-7'>
                              <Image layout='fill' src={`https://raw.githubusercontent.com/duiker101/pokemon-type-svg-icons/5781623f147f1bf850f426cfe1874ba56a9b75ee/icons/${item.pokemon_v2_type.name}.svg`} />
                            </span>
                          </div>
                        )
                      })
        ...
        <motion.section
          ...
          transition={{ duration: .5, type: 'tween' }}
          className={
            'relative flex flex-col justify-end items-center w-full sm:flex-row xl:w-auto grid-in-family [&>*:nth-child(1)]:order-2 [&>*:nth-child(2)]:order-1 sm:[&>*:nth-child(1)]:order-1 sm:[&>*:nth-child(2)]:order-2'
          }>
          <h1 className='font-sans text-base my-6 sm:text-xl xl:mt-32 2xl:mt-0  text-white font-semibold px-8'>
            {
